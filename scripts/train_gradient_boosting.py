...
MODEL_OUT = os.path.join(BASE_DIR, "output", "gradient_boosting_kdd_model.joblib")
METRICS_OUT = os.path.join(BASE_DIR, "output", "gradient_boosting_kdd_metrics.txt")
...
def main():
    ...
    print("\n" + "="*70)
    print("🚀 ENTRENANDO GRADIENT BOOSTING MACHINE (GBM)")
    print("="*70)
    ...
    with open(METRICS_OUT, "w", encoding="utf-8") as f:
        f.write("="*70 + "\n")
        f.write("GRADIENT BOOSTING MACHINE - RESULTADOS\n")
        f.write("="*70 + "\n\n")
        f.write("Best params:\n")
